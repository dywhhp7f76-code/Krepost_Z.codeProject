...
> Источник: https://portswigger.net/web-security/os-command-injection
...
Find OS command injection vulnerabilities using Burp Suite's web vulnerability scanner 
 ...
 [https://portswigger.net/research/hunting-asynchronous-vulnerabilities] Read PortSwigger Research's writeup of the Hunting Asynchronous Vulnerabilities presentation from 44Con and BSides Manchester 
