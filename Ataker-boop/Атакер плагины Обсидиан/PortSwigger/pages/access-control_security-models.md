...
source: https://portswigger.net/web-security/access-control/security-models
---

# PortSwigger: access-control / security-models

> Источник: https://portswigger.net/web-security/access-control/security-models
