...
> Источник: https://portswigger.net/web-security/sql-injection/blind
...
The second value causes the query to not return any results, because the injected condition is false. The "Welcome back" message is not
 displayed. 
