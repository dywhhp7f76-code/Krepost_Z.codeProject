...
source: https://portswigger.net/web-security/logic-flaws/examples
---

# PortSwigger: logic-flaws / examples

> Источник: https://portswigger.net/web-security/logic-flaws/examples
...
For detailed information on email parsing discrepancies, including how they can be exploited, see the [https://portswigger.net/research/splitting-the-email-atom] Splitting the Email Atom: Exploiting Parsers to Bypass Access Controls whitepaper by Gareth Heyes of the PortSwigger Research team. 
