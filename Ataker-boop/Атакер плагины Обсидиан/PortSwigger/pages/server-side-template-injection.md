...
> Источник: https://portswigger.net/web-security/server-side-template-injection
...
This technique was first documented by PortSwigger Research in the conference presentation [https://portswigger.net/research/server-side-template-injection] Server-Side Template Injection: RCE for the Modern Web App . 
...
Research 
 ...
 [https://portswigger.net/research/server-side-template-injection] Server-side template injection 
