...
> Источник: https://genai.owasp.org/llmrisk/llm092025-misinformation/

LLM09:2025 Misinformation - OWASP Gen AI Security Project Skip to content 
...
The model produces incorrect statements, leading users to make decisions based on false information. For example, Air Canada’s chatbot provided misinformation to travelers, leading to operational disruptions and legal complications. The airline was successfully sued as a result. (Ref. link: [https://www.bbc.com/travel/article/20240222-air-canada-chatbot-misinformation-what-travellers-should-know] BBC ) 
...
The model generates baseless assertions, which can be especially harmful in sensitive contexts such as healthcare or legal proceedings. For example, ChatGPT fabricated fake legal cases, leading to significant issues in court. (Ref. link: [https://www.legaldive.com/news/chatgpt-fake-legal-cases-generative-ai-hallucinations/651557/] LegalDive ) 
...
The model gives the illusion of understanding complex topics, misleading users regarding its level of expertise. For example, chatbots have been found to misrepresent the complexity of health-related issues, suggesting uncertainty where there is none, which misled users into believing that unsupported treatments were still under debate. (Ref. link: [https://www.kff.org/health-misinformation-monitor/volume-05/] KFF ) 
...
The model suggests insecure or non-existent code libraries, which can introduce vulnerabilities when integrated into software systems. For example, LLMs propose using insecure third-party libraries, which, if trusted without verification, leads to security risks. (Ref. link: [https://www.lasso.security/blog/ai-package-hallucinations] Lasso ) 
...
Reference Links 
 ...
 [https://www.kff.org/health-misinformation-monitor/volume-05/] AI Chatbots as Health Information Sources: Misrepresentation of Expertise : KFF 

 [https://www.bbc.com/travel/article/20240222-air-canada-chatbot-misinformation-what-travellers-should-know] Air Canada Chatbot Misinformation: What Travellers Should Know : BBC 

 [https://www.legaldive.com/news/chatgpt-fake-legal-cases-generative-ai-hallucinations/651557/] ChatGPT Fake Legal Cases: Generative AI Hallucinations : LegalDive 

 [https://towardsdatascience.com/llm-hallucinations-ec831dcd7786] Understanding LLM Hallucinations : Towards Data Science 

 [https://techpolicy.press/how-should-companies-communicate-the-risks-of-large-language-models-to-users/] How Should Companies Communicate the Risks of Large Language Models to Users? : Techpolicy 

 [https://www.washingtonpost.com/media/2023/01/17/cnet-ai-articles-journalism-corrections/] A news site used AI to write articles. It was a journalistic disaster : Washington Post 

 [https://www.lasso.security/blog/ai-package-hallucinations] Diving Deeper into AI Package Hallucinations : Lasso Security 

 [https://arxiv.org/abs/2304.09655] How Secure is Code Generated by ChatGPT? : Arvix 

 [https://thenewstack.io/how-to-reduce-the-hallucinations-from-large-language-models/] How to Reduce the Hallucinations from Large Language Models : The New Stack 

 [https://newsletter.victordibia.com/p/practical-steps-to-reduce-hallucination] Practical Steps to Reduce Hallucination : Victor Debia 

 [https://www.microsoft.com/en-us/research/publication/a-framework-for-exploring-the-consequences-of-ai-mediated-enterprise-knowledge-access-and-identifying-risks-to-workers/] A Framework for Exploring the Consequences of AI-Mediated Enterprise Knowledge : Microsoft 
...
Refer to this section for comprehensive information, scenarios strategies relating to infrastructure deployment, applied environment controls and other best practices. 
 ...
 [https://atlas.mitre.org/techniques/AML.T0048] AML.T0048.002 – Societal Harm MITRE ATLAS 

Share this: 

 [https://genai.owasp.org/llmrisk/llm092025-misinformation/?share=twitter] Share on X (Opens in new window) X 

 [https://genai.owasp.org/llmrisk/llm092025-misinformation/?share=facebook] Share on Facebook (Opens in new window) Facebook 

More 

 [https://genai.owasp.org/llmrisk/llm092025-misinformation/#print?share=print] Print (Opens in new window) Print 

Email a link to a friend (Opens in new window) Email 

 [https://genai.owasp.org/llmrisk/llm092025-misinformation/?share=x] Share on X (Opens in new window) X 
