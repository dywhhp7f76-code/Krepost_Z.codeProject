...
через TOTP — пишет код и создаёт автономных агентов.
...
| **3** | База знаний и RAG: структура markdown, индексация, пополнение оператором | ⏳ TBD |
| **4** | Петля и протокол: FeedbackEntry, batch_size, история, логирование | ⏳ TBD |
| **5** | Интеграция с существующим кодом (`__init__.py`, env vars, CLI) | ⏳ TBD |
| **6** | Тестирование и ошибки: моки LLM, edge cases | ⏳ TBD |
