...
>
> **Парковка (Крепость):** `krepost/07-RESEARCH/deferred/defense/`  
> **Календарь (если есть):** `docs/planning/CALENDAR.md`
...
Парковка: `krepost/07-RESEARCH/deferred/defense/cncf-k8s-deep.md`
...
- **DEFERRED:** Practical Alerting / Overload / postmortem → `krepost/07-RESEARCH/deferred/defense/sre-alerting-overload.md`
...
Парковка deep: `krepost/07-RESEARCH/deferred/defense/azure-ai-security-deep.md`
...
Кинь ответ — заведу только отобранное в `krepost/07-RESEARCH/knowledge-bases/sources/`.
